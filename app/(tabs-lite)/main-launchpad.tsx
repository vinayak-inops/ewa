  ...
  return (
    <View className="flex-1 bg-[#f4f5f7]">
      ...
      >
        ...
        {/* EWA Card */}
        <Pressable
          className="rounded-2xl overflow-hidden p-3 bg-[#0a1c63]"
          style={({ pressed }) => [
            { minHeight: 104 },
        ...
        >
          <View className="absolute" style={{ width: 140, height: 140, borderRadius: 70, right: -24, top: -84, backgroundColor: '#1e3a8a' }} />
          <View className="absolute" style={{ width: 160, height: 120, borderRadius: 60, right: -18, bottom: -76, backgroundColor: '#172554' }} />

          <View className="flex-row justify-between items-start">
            <View className="flex-1 pr-3">
              <Text className="text-base font-bold leading-[21px] text-white">EWA</Text>
              <Text className="text-xs font-semibold leading-[17px] mt-[3px] text-[#c7d2fe]">
