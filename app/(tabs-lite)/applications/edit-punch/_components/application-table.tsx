...
import { Check, ChevronDown, ChevronLeft, ChevronRight, LogIn, Search, X } from "lucide-react-native"
...
const TAB_DESC: Record<EditPunchTabKey, string> = {
  all:       "Showing all edit punch applications.",
...
const SEARCH_FIELDS = [
  ...
  { value: "newAttendanceDate", label: "New Att. Date", icon: "📅" },
