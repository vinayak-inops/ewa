...
import EncashmentApplication from "./_components/EncashmentApplication"
import EncashmentApplicationApprover from "./_components/EncashmentApplicationApprover"

export default function EncashmentApplicationPage() {
          ...
          <View className="px-5 py-10">
            <View className="max-w-lg self-center w-full border border-yellow-200 bg-yellow-50 rounded-lg p-6 items-center">
              ...
              <Text className="text-xs text-gray-500 mt-1 text-center leading-relaxed">
                You do not have permission to view Encashment Applications.
              </Text>
            </View>
          </View>
        )}
