...
const TAB_DESC: Record<EncashmentTabKey, string> = {
  all:       "Showing all encashment applications.",
...
const SEARCH_FIELDS = [
  ...
  { value: "leaveCode",   label: "Leave Code",   icon: "📋" },
                ...
                <React.Fragment key={row._id || idx}>
                  ...
                  >
                    ...
                    <View style={{ flex: 1, gap: 2 }}>
                      <Text style={{ fontSize: 13, fontWeight: "600", color: "#0f172a" }} numberOfLines={1}>{row.employeeID || "Encashment Request"}</Text>
