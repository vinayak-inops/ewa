...
const SEARCH_FIELDS: SearchField[] = [
  ...
  { label: 'Leave Code',    field: 'leaveCode',     icon: 'pricetag-outline', iconColor: '#f97316', iconBg: '#fff7ed' },
  { label: 'Applied Date',  field: 'appliedDate',   icon: 'calendar-outline', iconColor: '#ef4444', iconBg: '#fef2f2' },
