...
import { ChevronLeft, ChevronRight, FileText, LogIn } from "lucide-react-native"
...
export default function ApplicationTable({
  ...
  activeTab, onTabChange, onNew, title = "Punch Applications",
    ...
    <View style={{ flex: 1, backgroundColor: "#f8fafc" }}>
      ...
      <View style={s.banner}>
        <View style={s.bannerText}>
          <Text style={s.bannerTitle}>Forgot to Punch? We've Got You.</Text>
          <Text style={s.bannerSub}>Submit & track missed punch requests instantly</Text>
          {/* <Pressable style={s.bannerLink}>
            <Text style={s.bannerLinkText}>Learn More →</Text>
          </Pressable> */}
        </View>
        <View style={s.bannerIcon}>
          <LogIn size={38} color="rgba(255,255,255,0.25)" />
        </View>
      </View>
