...
import { CalendarCheck, ChevronLeft, ChevronRight, FileText } from "lucide-react-native"
...
export default function CompoffTable({
  ...
  onNew, title = "Comp Off Applications",
    ...
    <View style={{ flex: 1, backgroundColor: "#f8fafc" }}>
      ...
      <View style={s.banner}>
        <View style={s.bannerText}>
          <Text style={s.bannerTitle}>Rest Day Earned, Day Off Deserved.</Text>
          <Text style={s.bannerSub}>Submit & track compensatory off requests instantly</Text>
          {/* <Pressable style={s.bannerLink}>
            <Text style={s.bannerLinkText}>Learn More →</Text>
          </Pressable> */}
        </View>
        <View style={s.bannerIcon}>
          <CalendarCheck size={38} color="rgba(255,255,255,0.25)" />
        </View>
      </View>
