...
export type LeaveTabKey = 'all' | 'pending' | 'approved' | 'rejected' | 'cancelled' | 'failed'
...
interface ApplicationTableProps {
  ...
  onTabChange: (tab: LeaveTabKey) => void
    ...
    <View style={{ flex: 1, backgroundColor: '#f8fafc' }}>
      ...
      <View style={[s.header, { paddingTop: insets.top + 14 }]}>
        ...
        <View style={s.recordsBadge}>
          <Text style={s.recordsBadgeText}>{totalItems} records</Text>
        </View>
      </View>
      ...
      <View style={s.banner}>
        <View style={s.bannerText}>
          <Text style={s.bannerTitle}>Apply Leave Hassle-Free.</Text>
          <Text style={s.bannerSub}>Submit & track leave requests instantly</Text>
      ...
      <View style={{ backgroundColor: '#f8fafc', paddingHorizontal: 12, paddingTop: 12, paddingBottom: 100 }}>
        ...
        <View style={s.card}>
          ...
          {/* Internal search (when hideSearchBar is false) */}
          {!hideSearchBar && (
                      ...
                      <View style={{ flex: 1, gap: 2 }}>
                        <Text style={{ fontSize: 13, fontWeight: '700', color: '#0f172a' }} numberOfLines={1}>
                          {row.employeeID && row.employeeName
                            ? `${row.employeeID} - ${row.employeeName}`
                            : row.employeeName || row.employeeID || 'Leave Request'}
                        </Text>
