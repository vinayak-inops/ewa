...
const TAB_DESC: Record<SpecialLeaveTabKey, string> = {
  all:       'Showing all special leave applications.',
        ...
        <View style={{ marginHorizontal: 12, marginBottom: 12, backgroundColor: '#fff', borderRadius: 16, padding: 14 }}>
          ...
          {loading ? (
            ...
            currentData.map((row, idx) => {
              ...
              const title = row.leaveTitle || 'Special Leave'
                ...
                <React.Fragment key={row._id || idx}>
                  ...
                  >
                    ...
                    <View style={{ flex: 1, gap: 3 }}>
                      ...
                      {meta ? (
                        <Text style={{ fontSize: 11, color: '#94a3b8' }} numberOfLines={1}>{meta}</Text>
                      ) : null}
                      {row.remarks ? (
