...
export type OutDutyTabKey = "all" | "pending" | "failed" | "approved" | "cancelled" | "rejected"
...
export default function OutDutyFilters({
      ...
      <View style={{ flexDirection: "row", gap: 8, alignItems: "center" }}>
        ...
        {!hideApplyButton && (
          <TouchableOpacity
            ...
            style={{ height: 36, paddingHorizontal: 14, backgroundColor: "#7c3aed", borderRadius: 8, alignItems: "center", justifyContent: "center" }}
          >
        ...
        <View style={{ backgroundColor: "#fff", borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 10, overflow: "hidden" }}>
          {SEARCH_FIELDS.map(f => (
            <TouchableOpacity
              ...
              style={{ paddingHorizontal: 16, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: "#f9fafb", backgroundColor: searchField === f.value ? "#f5f3ff" : "#fff" }}
            >
              <Text style={{ fontSize: 13, color: searchField === f.value ? "#6d28d9" : "#374151", fontWeight: searchField === f.value ? "600" : "400" }}>
                {f.label}
              </Text>
            </TouchableOpacity>
          ))}
