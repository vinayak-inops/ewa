...
const TAB_DESC: Record<OutDutyTabKey, string> = {
  all:       "Showing all out duty applications.",
...
const SEARCH_FIELDS = [
  ...
  { value: "OutDutyAddress", label: "Location",    icon: "📍" },
...
export default function OutDutyTable({
  ...
  activeTab, onTabChange, onNew, title = "Out Duty Applications", subtitle,
}: Props) {
                ...
                <React.Fragment key={row._id || idx}>
                  ...
                  >
                    ...
                    <View style={{ flex: 1, gap: 2 }}>
                      <Text style={{ fontSize: 13, fontWeight: "600", color: "#0f172a" }} numberOfLines={1}>{row.employeeID || "Out Duty Request"}</Text>
