...
const SEARCH_FIELDS: SearchField[] = [
  ...
  { label: 'Reason',        field: 'Reason',           icon: 'help-circle-outline', iconColor: '#0ea5e9', iconBg: '#f0f9ff' },
...
export default function OutDutyApplicationApprover() {
  const [applications, setApplications] = useState<OutDutyRecord[]>([])
  const [activeTab, setActiveTab] = useState<OutDutyTabKey>("pending")
