...
interface Props {
  ...
  initialSelectedRequest: OutDutyRequest | null
...
function mapBackend(i: any): OutDutyRequest {
  return {
...
export default function OutDutyRequestsPopup({ isOpen, onClose, selectedRequestId, initialSelectedRequest, userMode, sourceCollectionName, onActionSuccess }: Props) {
  ...
  const approverPerms = useScreenPermissions("applicationApprover", "outDuty")
  ...
  if (submitSuccess) {
    ...
    const subtitle = isApprove
      ? "The out duty request has been approved successfully."
      : isReject
      ? "The out duty request has been rejected."
      : "The out duty request has been cancelled."
      ...
      <View className="flex-1 bg-white">
        ...
        <View style={{ paddingHorizontal: 14, paddingTop: 58, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: '#e5e7eb', backgroundColor: '#fff' }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 4 }}>
            ...
            <Text style={{ fontFamily: 'Inter', fontSize: 20, fontWeight: '700', color: '#0f172a' }}>Out Duty Application</Text>
          </View>
        </View>
