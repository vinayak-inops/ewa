...
export type WfhTabKey = "all" | "pending" | "failed" | "approved" | "cancelled" | "rejected"
      ...
      <View style={{ flexDirection: "row", gap: 8, alignItems: "center" }}>
        ...
        {!hideApplyButton && (
          <TouchableOpacity
            ...
            style={{ height: 36, paddingHorizontal: 14, backgroundColor: "#16a34a", borderRadius: 8, alignItems: "center", justifyContent: "center" }}
          >
